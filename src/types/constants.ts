...
export const SNGConstants = {
    ...
    NOTE_MASK_IGNORE: 0x040000,   // ignore:1
    ...
    NOTE_MASK_SINGLE: 0x00800000, // single note
    NOTE_MASK_CHORDNOTES: 0x01000000, // has chordnotes exported
    NOTE_MASK_DOUBLESTOP: 0x02000000,
    NOTE_MASK_ACCENT: 0x04000000,
    NOTE_MASK_PARENT: 0x08000000, // linkNext:1
    NOTE_MASK_CHILD: 0x10000000, // note after linkNext:1
    NOTE_MASK_ARPEGGIO: 0x20000000,
    // missing - not used in lessons/songs            0x40000000
    NOTE_MASK_STRUM: 0x80000000, // handShape defined at chord time
